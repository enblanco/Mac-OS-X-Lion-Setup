...
sudo scutil --set ComputerName "enblanco"
sudo scutil --set HostName "enblanco"
sudo scutil --set LocalHostName "enblanco"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "enblanco"
...
#defaults write NSGlobalDomain com.apple.trackpad.scaling "<real>0.875</real>"
